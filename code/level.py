...
from code.Const import C_WHITE, WIN_HEIGHT, C_BLACK, MENU_OPTION, EVENT_ENEMY, SPAWN_TIME, C_GREEN, C_CYAN, \
...
class Level:
    ...
    def run(self, player_score: list[int]):
        ...
        while True:
            ...
            self.level_text(14, f'entidades: {len(self.entity_list)}', C_BLACK, (10,WIN_HEIGHT - 20))
            pygame.display.flip()
            # Collisions
